...
// Copyright (c) 2009-2014 The Bitcoin, Novacoin, and Quantum developers
...
unsigned int nStakeTargetSpacing = 1 * 60; // 1 minute
...
int CMerkleTx::GetBlocksToMaturity() const
{
    ...
    return max(0, (nCoinbaseMaturity+10) - GetDepthInMainChain()); // increase maturity of mined blocks
...
// quantum: find block wanted by given orphan block
...
static const int64 nTargetTimespan = 16 * 60;  // 16 minutes
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake)
{
    ...
    // quantum: target change every block
    // quantum: retarget with exponential moving toward target spacing
    CBigNum bnNew;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Quantum
    bool fStrictPayToScriptHash = true; // Always active in Quantum
    ...
    // quantum: fees are not collected by miners as in bitcoin
    // quantum: fees are destroyed to compensate the entire network
    if (fDebug && GetBoolArg("-printcreation"))
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Quantum: check proof-of-stake block signature
...
bool ProcessBlock(CNode* pfrom, CBlock* pblock)
{
    ...
    // quantum: verify hash target and signature of coinstake tx
...
// quantum: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnTrustedModulus.SetHex("");
    ...
    {
		bnTrustedModulus.SetHex("");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "April 23, 2014 Regulators pave way for Internet fast lane with net neutrality rules";
        CTransaction txNew;
        txNew.nTime = 1398307720;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1398307720;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 39129 : 5607;

        //// debug print
        uint256 hash = block.GetHash();
        assert(block.hashMerkleRoot == uint256("0x41904a57ff9581af1694a473726977a06b052ffbc97fd58781c81b28b2a8f9d0"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xce, 0xd2, 0xe9, 0xeb };
