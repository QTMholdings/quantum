...
static const int64 MAX_MINT_PROOF_OF_STAKE = 0 * COIN;
...
static const uint256 hashGenesisBlockTestNet("0x0000a7cda048e972122233067e808a553c816bcfeca4672e79fb9d86a606e799");
static const uint256 hashGenesisBlock("0x000114377bb9d3d720e75830eeff664237df149eae08bcc88101c86785845f07");

inline int64 PastDrift(int64 nTime)   { return nTime - 10 * 60; } // up to 10 mins from the past
inline int64 FutureDrift(int64 nTime) { return nTime + 10 * 60; } // up to 10 mins from the future
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // quantum: get transaction coin age
...
public:
    ...
    // quantum: entropy bit for stake modifier if chosen by modifier
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // quantum: calculate total coin age spent in block
